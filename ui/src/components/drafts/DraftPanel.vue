...
// ── Limits ──
interface LimitEntry { title?: number; minBody?: number; body?: number; maxImages?: number; maxTags?: number; abstract?: number; aspectRatio?: string }
...
async function handlePaste(e: ClipboardEvent) {
  if (editType.value !== 'article') return
    ...
    <Teleport to="body">
      <div v-if="isNew || editing" class="editor-overlay" @click.self="closeEditor">
        <div class="editor">
          ...
          <!-- 摘要（长文） -->
          <label v-if="editType === 'article'" class="field">
            <span>文章摘要</span>
          ...
          <div class="materials-section">
            <!-- 图片上传（仅图文） -->
            <div v-if="editType === 'image_text'" class="material-group">
            ...
            <!-- 头图上传（长文） -->
            <div v-if="editType === 'article'" class="material-group">
            ...
            <!-- 视频上传（视频类型） -->
            <div v-if="editType === 'video'" class="material-group">
